  ...
  return (
    <div>
      <footer className="footer xl:px-24 py-10 px-4 text-base-content">
        <aside>
          <img src="/favicon.ico" alt="" className="w-24"/>
          <p className="my-3 md:w-40">
            Savor the artistry where every dish is a culinary masterpiece with a pinch of passion
          </p>
        </aside>
        <nav>
        ...
        <nav>
          ...
          <a className="link link-hover">pivaofficial604@gmail.com</a>
          <a className="link link-hover">+8878000000</a>
